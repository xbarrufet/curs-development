...
Ja coneixes els principis de clean code (noms significatius, funcions petites, early return) de la S1 — els has aplicat en cada PR des de llavors. Avui pugem un nivell: no és només llegibilitat, és seguretat.
