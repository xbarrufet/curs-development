# Setmana 09 — Divendres: Observabilitat de Contenidors i Consolidació
...
**Per què els logs en format JSON (S6, correlation IDs) són importants aquí:** Si cada servei emet logs en JSON amb un `correlation_id`, pots filtrar per una petició concreta que travessa múltiples serveis. Sense JSON estructurat, només tens text pla barrejat.
...
git checkout -b feature/week9-docker
git push -u origin feature/week9-docker
```
